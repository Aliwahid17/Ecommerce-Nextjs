            ...
            <div className="xl:ml-20 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0">
              <form onSubmit={handleSubmit} method='POST'>
                ...
                <div className="flex justify-between items-center mb-6">
                  ...
                  <Link href={"/forget"}><a className="text-gray-800">Forgot password?</a></Link>
                </div>
                ...
                <div className="text-center lg:text-left">
                  ...
                  <p className="text-sm font-semibold mt-2 pt-1 mb-0">
                    ...
                    <Link href={'/signup'}><a className="text-red-600 hover:text-red-700 focus:text-red-700 transition duration-200 ease-in-out ml-1" >Sign Up</a></Link>
                  </p>
                </div>
              </form>
            </div>
