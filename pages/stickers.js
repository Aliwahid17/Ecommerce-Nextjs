            ...
            <Link href={'/product/wear-the-code'}>
              <div className="lg:w-1/4 md:w-1/2 p-4 w-full grid justify-items-center cursor-pointer shadow-lg mb-6   ">
                <a className="block relative  rounded overflow-hidden">
                  <img alt="ecommerce" className="h-[30vh] md:h-[36vh] object-center block" src="https://images-eu.ssl-images-amazon.com/images/I/61ogNnLoGHL._SX300_SY300_QL70_FMwebp_.jpg" />
                </a>
